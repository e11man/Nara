...
export function Footer({
  ...
  return (
    <footer className="pb-6 pt-16 lg:pb-8 lg:pt-24 bg-white border-t border-gray-200">
            ...
            {socialLinks.map((link, i) => (
              <li key={i}>
                <Button
                  variant="outline"
                  size="icon"
                  className="h-10 w-10 rounded-full border-gray-300 hover:bg-gray-50 hover:border-gray-400"
                  asChild
                >
            ...
            <ul className="list-none flex flex-wrap -my-1 -mx-2 lg:justify-end">
              {mainLinks.map((link, i) => (
                <li key={i} className="my-1 mx-2 shrink-0">
                  <a
                    href={link.href}
                    className="text-sm text-gray-700 hover:text-gray-900 underline-offset-4 hover:underline font-medium"
                  >
                    {link.label}
                  </a>
                </li>
